            ...
            setTimeout(function() {
                $('.deck').each(function() {
                    ...
                    swal({
                        ...
                        type: 'success',
                        text: 'You won the game! It took you ' + moves + ' moves. You got ' + stars + ' Star(s). It took you ' + hours + ' Hours ' + min + ' Minutes and ' + sec + ' Seconds.',
                        allowOutsideClick: false,
                        showCancelButton: true,
                        confirmButtonText: 'Play Again?',
                        confirmButtonColor: '#008B00',
